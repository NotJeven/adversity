...
# flavour
execute if score #teamReadySpectator var = #TURNREADY var run tellraw @a[scores={triggerTeamReady=1},team=spectator] [{"text":"Ready spectator"}]
execute if score #teamReadySpectator var = #TURNREADY var run title @a[scores={triggerTeamReady=1},team=spectator] subtitle [{"text":"Ready spectator"}]
...
execute if score #teamReadySpectator var = #TURNNOTREADY var run tellraw @a[scores={triggerTeamReady=1},team=spectator] [{"text":"Not Ready spectator"}]
execute if score #teamReadySpectator var = #TURNNOTREADY var run title @a[scores={triggerTeamReady=1},team=spectator] subtitle [{"text":"Not Ready spectator"}]
