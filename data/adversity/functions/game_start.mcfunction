...
execute at @e[tag=pad15] run summon blaze ~ ~ ~ {PersistenceRequired:true,AbsorptionAmount:280f,Tags:["leftObjective"],Invulnerable:1b,Silent:1b,Glowing:0b}
execute at @e[tag=pad16] run summon blaze ~ ~ ~ {PersistenceRequired:true,AbsorptionAmount:280f,Tags:["rightObjective"],Invulnerable:1b,Silent:1b,Glowing:0b}