...
# move player
teleport @a[tag=!initialized] 480 60 0 -90 24
...
tellraw @a[tag=!initialized] [{"text":"Download: ","color":"white"},{"text":"notjeven.github.io/adversity ","color":"gold","clickEvent":{"action":"open_url","value":"notjeven.github.io/adversity"},"hoverEvent":{"action":"show_text","value":"Go to the Adversity webpage."}},{"text":"↗","color":"gold","underlined":"true","hoverEvent":{"action":"show_text","value":"Go to the Adversity webpage."},"clickEvent":{"action":"open_url","value":"notjeven.github.io/adversity"}}]
