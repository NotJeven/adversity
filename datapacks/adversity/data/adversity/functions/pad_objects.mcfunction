...
# red resource
summon area_effect_cloud 541 34 24 {Duration:2147483647,Tags:["pad","pad7","minorPad","itemPad","rightLane"]}
summon area_effect_cloud 554 31 11 {Duration:2147483647,Tags:["pad","pad8","minorPad","itemPad","rightLane"]}
summon area_effect_cloud 565 45 18 {Duration:2147483647,Tags:["pad","pad9","minorPad","itemPad","rightLane"]}
summon area_effect_cloud 578 44 20 {Duration:2147483647,Tags:["pad","pad10","minorPad","itemPad","rightLane"]}

# blue effect
summon area_effect_cloud 571 23 13 {Duration:2147483647,Tags:["pad","pad11","minorPad","effectPad","rightLane"]}
summon area_effect_cloud 583 38 14 {Duration:2147483647,Tags:["pad","pad12","minorPad","effectPad","rightLane"]}
