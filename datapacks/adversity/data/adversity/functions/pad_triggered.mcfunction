...
execute if score @s[tag=a] var < #MINORSUMMON var positioned ~-1 ~2 ~-1 run tellraw @a[dx=2,dy=1,dz=2,team=a] [{"text":"Summoning (","color":"gray"},{"score":{"name":"#statusTime","objective":"var"},"color":"white"},{"text":"s","color":"white"},{"text":")","color":"gray"}]
execute if score @s[tag=b] var < #MINORSUMMON var positioned ~-1 ~2 ~-1 run tellraw @a[dx=2,dy=1,dz=2,team=b] [{"text":"Summoning (","color":"gray"},{"score":{"name":"#statusTime","objective":"var"},"color":"white"},{"text":"s","color":"white"},{"text":")","color":"gray"}]
execute if score @s[tag=a] var > #MINORSUMMON var positioned ~-1 ~2 ~-1 run tellraw @a[dx=2,dy=1,dz=2,team=a] [{"text":"Cooldown (","color":"gray"},{"score":{"name":"#statusTime","objective":"var"},"color":"white"},{"text":"s","color":"white"},{"text":")","color":"gray"}]
execute if score @s[tag=b] var > #MINORSUMMON var positioned ~-1 ~2 ~-1 run tellraw @a[dx=2,dy=1,dz=2,team=b] [{"text":"Cooldown (","color":"gray"},{"score":{"name":"#statusTime","objective":"var"},"color":"white"},{"text":"s","color":"white"},{"text":")","color":"gray"}]

execute if score @s[tag=majorPad] var = #FALSE var run scoreboard players operation @s[tag=majorPad] var = #TRUE var
execute if score @s[tag=majorPad] var < #MAJORSUMMON var positioned ~-2 ~2 ~-3 run tellraw @a[dx=4,dy=1,dz=6] [{"text":"Summoning (","color":"gray"},{"score":{"name":"#statusTime","objective":"var"},"color":"white"},{"text":"s","color":"white"},{"text":")","color":"gray"}]
execute if score @s[tag=majorPad] var > #MAJORSUMMON var positioned ~-2 ~2 ~-3 run tellraw @a[dx=4,dy=1,dz=6] [{"text":"Cooldown (","color":"gray"},{"score":{"name":"#statusTime","objective":"var"},"color":"white"},{"text":"s","color":"white"},{"text":")","color":"gray"}]
...
execute if score @s[tag=objectivePad] var > #FALSE var positioned ~-1 ~2 ~-1 run tellraw @a[dx=2,dy=1,dz=2] [{"text":"Summoning (","color":"gray"},{"score":{"name":"#statusTime","objective":"var"},"color":"white"},{"text":"s","color":"white"},{"text":")","color":"gray"}]
execute if score @s[tag=objectivePad] var > #OBJECTIVESUMMON if if score @s[tag=objectivePad] var < #OBJECTIVECOOLDOWN var positioned ~-1 ~2 ~-1 run tellraw @a[dx=2,dy=1,dz=2] [{"text":"Cooldown (","color":"gray"},{"score":{"name":"#statusTime","objective":"var"},"color":"white"},{"text":"s","color":"white"},{"text":")","color":"gray"}]
