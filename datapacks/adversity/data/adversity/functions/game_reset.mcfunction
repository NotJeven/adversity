...
tellraw @s [{"text":"Adversity is ","color":"white"},{"text":"resetting","color":"light_purple"},{"text":", please wait.","color":"white"}]
...
tellraw @a [{"text":"Adversity has been "},{"text":"reset","color":"light_purple"},{"text":".","color":"white"}]
title @a subtitle [{"text":"Adversity has been "},{"text":"reset","color":"light_purple"},{"text":".","color":"white"}]
title @a title ""
